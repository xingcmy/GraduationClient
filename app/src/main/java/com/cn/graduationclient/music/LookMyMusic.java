...
public class LookMyMusic extends Activity {
        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            switch (msg.what){
                case 0x01:
                    ...
                    try {
                        ...
                        if (error.equals(StructureSystem.SUCCESS)){
                            Toast.makeText(LookMyMusic.this,"删除成功",Toast.LENGTH_LONG).show();
                            out_long.dismiss();
                            onCreate(null);
                        }
                ...
                case 0x02:
                    ...
                    if (count!=0){
                        musicList=new SetFriendMusic().getMusic(LookMyMusic.this,FriendMusic,name);
                        LookMusicAdapter adapter=new LookMusicAdapter(LookMyMusic.this,musicList);
...
//        listView.setAdapter(adapter);
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                View view1= LinearLayout.inflate(LookMyMusic.this,R.layout.playlookmusic,null);
                final AlertDialog.Builder ab=new AlertDialog.Builder(LookMyMusic.this);
                out_long=ab.create();
...
//                    String  filePath=new MsgTool().getFileByBytes(bytes,LookMyMusic.this.getExternalFilesDir(null).getPath(),MusicName);
//                    button.setText("开始播放");
//                    button.setOnClickListener(new View.OnClickListener() {
//                        @Override
//                        public void onClick(View v) {
